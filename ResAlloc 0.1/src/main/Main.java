...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Iteration,Agent,ContractResources,Resources,Funds,ContractsBought,SlackLowerBound,Average,Consumption");
		/**
...
//		Random generator = new Random(n);
		...
		int slack1 = 0;
		int slack2 = 0;
		new PAgent(0,100).start();
		System.out.println("<-Simulation started.->");
		for (int i = 0; i<200; i++){
			System.out.println("<-1->");
			System.out.println("average1 "+average1);
//			cons1 = (int)(generator.nextInt(n)* generator.nextGaussian());
//			average1 = ((int)stdDev.avg(average1, average1-cons1, i+1)); 
//			slack1 = (average1-((int)stdDev.sdKnuth(average1, average1-cons1)));
			t1.go(5000, 4000, 250);						//want to keep close to average value. 
			p.println(i+",1,"+D1.retTotalRes(1)+
					","+O1.retrieveAmountfromORtbl(1)+
...
//			cons2 = (int)(generator.nextInt(n)*generator.nextGaussian());
